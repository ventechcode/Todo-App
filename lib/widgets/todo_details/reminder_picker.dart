  ...
  void initState() {
    ...
    if (widget.notificationDate != null) {
      ...
      _notificationTime = TimeOfDay(
          hour: _notificationDate.hour, minute: _notificationDate.minute);
    }
  }
                ...
                showDatePicker(
                  ...
                  showTimePicker(
                    ...
                    setState(() {
                      ...
                      widget.databaseService.updateReminderDate(
                          widget.todoID, _dateTime);
                    });
                  });
                });
              },
              child: Row(
                children: [
                  _notificationDate == null && _notificationTime == null
                    ...
                    Icons.notifications,
                    size: 31,
                    color: toDouble(_notificationTime) < toDouble(TimeOfDay.now()) && DateTime.now().isAfter(_notificationDate) ? Colors.grey[700] : Colors.lightBlue,
                  ),
                  SizedBox(
                    width: 8,
                  ),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: toDouble(_notificationTime) <
                                toDouble(TimeOfDay.now()) && DateTime.now().isAfter(_notificationDate)
                                ? Colors.grey[700]
                                : Colors.lightBlue,
                            fontSize: 15,
                            fontWeight: FontWeight.w500,
                        ...
                        Container(
                          ...
                          child: Text(
                            _dateFormat.format(_notificationDate) ==
                                ...
                                ? 'Heute'
                                : _notificationDate.day == DateTime
                                .now()
                                .day + 1 ? 'Morgen' : _notificationDate.day == DateTime
                                .now()
                                .day - 1 ? 'Gestern' : _dateFormat.format(_notificationDate),
                            style: TextStyle(
                              color: Colors.grey[700],
                              fontSize: 13,
                            ),
